...
const validTypes = ['shirts', 't-shirt', 'football shirt', 'jacket', 'pants', 'mate', 'yerba', 'alfajores', 'wine', 'short', 'socks', 'wallet', 'purse', 'accessories', 'bag', 'espadrilles','footwear']
...
const ProductAdminPage: FC<Props> = ({ product, }) => {
    ...
    useEffect(() => {
        if (getValues('gender') == 'regionales' && getValues('type') != 'espadrilles'  ) {
            setIsHidden(true)
        } else {
            setIsHidden(false)
        }
