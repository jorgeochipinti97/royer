...
const OrderPage: NextPage<Props> = ({ order }) => {
  ...
  const crypto = [
    "https://res.cloudinary.com/djk4q3tys/image/upload/v1649803353/vdcqamydvmx70cksuubo.png",
    "https://res.cloudinary.com/djk4q3tys/image/upload/v1649803353/ixqoo5kldhyiy57kuhcr.png",
    "https://res.cloudinary.com/djk4q3tys/image/upload/v1649803353/vahsohmh1mozb9tpfbpz.png",
    "https://res.cloudinary.com/djk4q3tys/image/upload/v1649803352/zkbtzcdmjqfmtad7ypxw.png",
    "https://res.cloudinary.com/djk4q3tys/image/upload/v1649803352/benu5ggpqtwdo7pn4axj.png",
  ];
  ...
  return (
    <ShopLayout title="Order Resume" pageDescription={"Order Resume"}>
      ...
      {order.transactionId != "null" ||
        (!order.transactionId.toLowerCase().includes("refund") && (
        ...
        <Box display="flex" justifyContent="center">
          <Box sx={{ mb: 5, border: "1px dashed grey" }}>
            <Typography align="center" variant="subtitle1" sx={{ m: 1 }}>
              You will be receiving an email in 48 hs with your purchase invoice
            </Typography>
          </Box>
        </Box>
      )}
                ...
                {order.isPaid && (
                  <>
                    ...
                    <Typography align="center" variant="body1">
                      You will be receiving an email in 48 hs with your purchase
                      invoice
                    </Typography>
                  </>
                )}
                {!order.isPaid && (
                  ...
                  <CheckoutComponent amount={order.total} order={order}/>
                    ...
                    <Box
                      ...
                      sx={{ display: !isWestern ? "none" : "block" }}
                    >
                      <Box display="flex" flexDirection="column">
                        <Box display="flex" justifyContent="center">
                          <Typography variant="subtitle1">
                            Fernando Gabriel Lansese
                          </Typography>
                        </Box>
                        <Box display="flex" justifyContent="center">
                          <Typography variant="subtitle1">
                        ...
                        <Box display="flex" justifyContent="center">
                          <form>
                            <FormControl>
                              <FormLabel sx={{ m: 1 }}>
                                Put your transaction id please!
                              </FormLabel>
                              <TextField
                              ...
                              <Button
                                type="submit"
                                onClick={() =>
                                  orderWhitTransactionId(`WSTRN-${hash_}`)
                                }
                                disabled={isDisable}
                                color="success"
                                sx={{ m: 3 }}
                        ...
                        <form>
                          <FormControl>
                            ...
                            <Button
                              ...
                              disabled={isDisable}
                              onClick={() =>
                                orderWhitTransactionId(`AIRTM-${hash_}`)
                              }
                              color="success"
                              sx={{ m: 3 }}
                            >
                    ...
                    <Grid container>
                      ...
                      >
                        <Typography variant="subtitle1">
                          {currency.format(
                            order.numberOfItems >= 3 ? order.total : criptoPrice
                          )}
                        </Typography>
                      </Grid>
                    </Grid>
